...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '萧晓', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '萌虎明朝将撷玉', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xjxx.vedfolnir.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '仓库, 自留地', // 网站关键词 英文逗号隔开
